...
$(document).ready(function () {
    ...
    $("#begin").click(function () {
        ...
        if (curPlayer == 1) {
            $(".startPopup").html("<h1>Player 1 goes first!</h1>");
        } else {
        ...
        $(".startPopup").on('click', function () {
            if (start == true && lock1 == 0) {
                ...
                if (curPlayer == 1) {
                    ...
                    $("#PlayerDice").attr("src", "images/dice" + dice + ".png");

                    $("#PlayerMask").css("display", "none");
                    $("#AIMask").css("display", "block");
                } else if (curPlayer == 2) {
                    $("#AIDice").css("display", "block");
                    $("#AIDice").attr("src", "images/dice" + dice + ".png");
...
function applyDiceChanges(PArr, AArr, curPlayer) {
    ...
    for (let x = 0; x < 3; x++) {
        for (var y = 0; y < 3; y++) {
            let PlayerDice = "images/dice" + PArr[x][y] + ".png";
            let AIDice = "images/dice" + AArr[x][y] + ".png";
